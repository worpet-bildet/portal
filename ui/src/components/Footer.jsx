      ...
      <div className="grid justify-items-start pt-3 px-4 bg-gray-100 dark:bg-gray-700">
        {disclaimer ? (
          <span className="border border-2 text-lg text-gray-500 p-2 mb-4">
            ...
            Disclaimer: Applications may not be audited for security and might contain
            malicious code or vulnerabilities that could lead to unwanted interaction with
            your ship. Explore at your own risk.
          </span>
        ) : null}
        <div className="flex flex-row justify-between w-full">
          <h3 className="mt-4">
            Tell us what you think in the Galleria group at ~dilryd-mopreg
          </h3>
          <a
