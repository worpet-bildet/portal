...
export function DeveloperTile({ name }) {
    ...
    api.poke({
      ...
      onSuccess: () =>
        notification.success(
          `You have been unsubscribed from ${name}, please refresh the page`
        ),
  ...
  return (
    <li className="flex flex-row justify-items-center">
      <Link
        to={`/apps/portal/cur/devs/${name}`}
        className="w-full border border-gray-900 flex justify-between py-3"
      >
