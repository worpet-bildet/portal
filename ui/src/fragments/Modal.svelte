...
{#if open}
  ...
  >
    <div
      class="inline justify-center items-center min-w-full md:min-w-[45rem] max-w-screen-lg max-h-screen md:max-h-[40rem] overflow-y-auto opacity-100 bg-offwhite dark:bg-black rounded-2xl"
